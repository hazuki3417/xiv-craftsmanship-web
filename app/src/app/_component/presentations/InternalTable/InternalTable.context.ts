...
export const InternalTableContext = createContext<InternalTableContextValue | undefined>(undefined);

export const useInternalTable = () => {
  const context = useContext(InternalTableContext);
  if (context === undefined) {
    throw new Error("useInternalTable must be used within a InternalTableProvider");
  }
  return context
}
