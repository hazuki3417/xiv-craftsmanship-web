					...
					<MaterialManagerProvider>
						...
						{segment === "crafts" && (
							<Grid.Col span={12}>
								...
								<Tabs.Panel style={{ paddingTop: "10px" }} value="6">
									<Recipe id="6" />
								</Tabs.Panel>
								<Tabs.Panel style={{ paddingTop: "10px" }} value="7">
									<Recipe id="7" />
								</Tabs.Panel>
								<Tabs.Panel style={{ paddingTop: "10px" }} value="8">
									<Recipe id="8" />
								</Tabs.Panel>
								<Tabs.Panel style={{ paddingTop: "10px" }} value="9">
									<Recipe id="9" />
								</Tabs.Panel>
								<Tabs.Panel style={{ paddingTop: "10px" }} value="10">
									<Recipe id="10" />
								</Tabs.Panel>
								<Tabs.Panel style={{ paddingTop: "10px" }} value="11">
									<Recipe id="11" />
								</Tabs.Panel>
