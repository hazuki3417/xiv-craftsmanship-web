...
export type GetMaterialsQuery = { __typename?: 'Query', materials: Array<{ __typename?: 'Material', parentId: string, childId: string, parentName: string, childName: string, unit: number, total: number }> };
